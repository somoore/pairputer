...
data plane. The Cognito token never reaches the relay. Full detail - lifetimes, PKCE, JWT validation - in [`../SECURITY.md`](../SECURITY.md#runtime-auth-cognito--agentcore-and-token-lifetimes).
